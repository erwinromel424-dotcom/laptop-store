...
@section('content')
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('admin.orders.detail.pdf', $order->id) }}"
                class="inline-flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 text-gray-300 hover:text-white hover:bg-white/10 rounded-xl text-xs font-bold transition-all">
